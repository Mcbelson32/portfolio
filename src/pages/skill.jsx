  ...
  return (
    ...
    >
      ...
      <div className="skills-container flex w-full flex-wrap items-center justify-center gap-24 lg:gap-12 ">
        <div data-aos={width > 1024 ? "fade-right" : "fade-up"} className="skill-list flex w-[450px] flex-col items-center justify-start gap-y-8">
        ...
        <div data-aos={width > 1024 ? "fade-left" : "fade-up"} className="skill-list flex w-[450px] flex-col items-center justify-start gap-y-8">
          <div className="skill w-full">
